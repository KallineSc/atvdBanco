...
public class MedicoHasEspecialidadeDAO extends ConexaoDB{
    ...
    private static final String INSERT_MEDICO_HAS_ESPECIALIDADE_SQL = "INSERT INTO medico_has_especialidade (rua, numero, complemento, bairro, cep, cidade, especialidade_id) VALUES (?, ?, ?, ?, ?, ?, ?);";
    private static final String SELECT_MEDICO_HAS_ESPECIALIDADE_BY_ID = "SELECT rua, numero, complemento, bairro, cep, cidade, especialidade_id FROM medico_has_especialidade WHERE id = ?";
    ...
    private static final String UPDATE_MEDICO_HAS_ESPECIALIDADE_SQL = "UPDATE medico_has_especialidade SET rua = ?, numero = ?, complemento = ?, bairro = ?, cep = ?, cidade = ?, especialidade_id = ? WHERE id = ?;";
